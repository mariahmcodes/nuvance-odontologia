...
const nuvanceButtonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-sans font-semibold uppercase tracking-[0.18em] transition-all duration-400 ease-elegant focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        petrol:
          "bg-petrol text-ivory hover:bg-petrol-deep shadow-soft md:hover:shadow-elegant",

        gold:
          "bg-gold text-petrol-deep hover:bg-gold-soft shadow-soft md:hover:shadow-gold-glow",
